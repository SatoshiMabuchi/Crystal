...
template<typename T>
Box3d<T> Box3d<T>::getOuterOffset(const T offsetLength) const
{
	Box3d box = *this;
...
template<typename T>
void Box3d<T>::innerOffset(const T offsetLength)
{
...
template<typename T>
Box3d<T> Box3d<T>::getInnerOffset(const T offsetLength) const
{
